...
export default function MemberContent() {
  ...
  const allDashboardTiles: ConsoleTileData[] = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h4 className="text-lg font-semibold text-fase-navy">The Entrepreneurial Underwriter</h4>

          {/* Latest Edition */}
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="bg-fase-navy p-4">
              <h5 className="text-base font-semibold text-white">Latest Edition</h5>
            </div>
            <div className="p-6">
              <Link
                href="/member-portal/bulletin/february-2026"
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <h6 className="text-base font-semibold text-fase-navy group-hover:underline mb-2">
                      Inaugural Edition
                    </h6>
    ...
    },
    {
      ...
      title: t('sections.lines_of_business'),
      icon: (
        <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
