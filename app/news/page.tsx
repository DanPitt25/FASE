...
export default function NewsPage() {
  ...
  return (
    <div className={`min-h-screen bg-fase-ice-blue font-lato transition-opacity duration-300 ${headerLoaded ? 'opacity-100' : 'opacity-0'}`}>
      <Header currentPage="news" onLoad={() => setHeaderLoaded(true)} />
      
      <main className="flex-1">
        <section className="bg-fase-navy py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-futura font-bold text-white mb-6">News</h1>
            <p className="text-xl text-fase-ice-blue max-w-3xl mx-auto">
              Stay updated with the latest from the European MGA community.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-fase-dark-slate mb-8">
              News and updates will be available once FASE is officially launched.
            </p>
