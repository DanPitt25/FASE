    ...
    <div className={`min-h-screen bg-fase-ice-blue font-lato transition-opacity duration-300 ${headerLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <main className="flex-1">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <nav className="flex justify-center mb-8">
              <ol className="flex items-center space-x-2 text-sm">
                ...
                <li className="text-fase-ice-blue">/</li>
                <li className="text-white font-medium">Affiliates & Associates</li>
              </ol>
            </nav>
            ...
            <p className="text-xl sm:text-2xl text-fase-ice-blue max-w-4xl mx-auto leading-relaxed">
              Strategic partnerships strengthening the European MGA ecosystem.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-futura font-bold text-fase-navy mb-6">Partnership Framework</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-fase-ice-blue rounded-2xl p-8 text-center">
                ...
                <h3 className="text-2xl font-futura font-bold text-fase-navy mb-4">Strategic Affiliates</h3>
              ...
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg border border-fase-light-gray">
                ...
                <h3 className="text-2xl font-futura font-bold text-fase-navy mb-4">Industry Associates</h3>
                <p className="text-fase-dark-slate leading-relaxed mb-6">
              ...
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg border border-fase-light-gray">
                ...
                <h3 className="text-2xl font-futura font-bold text-fase-navy mb-4">Regulatory Partners</h3>
                <p className="text-fase-dark-slate leading-relaxed mb-6">
        ...
        <section className="py-20 bg-fase-ice-blue">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-futura font-bold text-fase-navy mb-6">Key Relationships</h2>
              <p className="text-xl text-fase-dark-slate max-w-3xl mx-auto">
                ...
                <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="text-lg font-futura font-bold text-fase-navy mb-2 leading-tight">{partner.name}</h3>
                      <p className="text-fase-blue-gray text-sm">{partner.country}</p>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-futura font-bold text-fase-navy mb-6">Partnership Benefits</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-fase-sage rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Market Access</h3>
                      <p className="text-fase-dark-slate">Enhanced access to European markets through partner networks and relationships.</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-fase-navy rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Knowledge Sharing</h3>
                      <p className="text-fase-dark-slate">Access to shared research, best practices, and market intelligence across borders.</p>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-fase-orange rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Collective Voice</h3>
                      <p className="text-fase-dark-slate">Stronger advocacy position through coordinated industry representation.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-fase-navy">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-futura font-bold text-white mb-6">Partner with FASE</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/join" className="bg-fase-orange text-white px-8 py-4 rounded-xl text-lg font-medium hover:bg-yellow-600 transition duration-300">
                Explore Partnership
              </a>
