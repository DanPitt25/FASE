  ...
  return (
    <PageLayout currentPage="about" sections={sections}>
      ...
      <main className="flex-1">
        ...
        <ContentHero id="mission" fullHeight={true} className="bg-white py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-fase-steel leading-relaxed">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-fase-steel font-medium">Industry Leadership</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-fase-navy "></div>
                    <span className="text-fase-steel font-medium">Market Innovation</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-fase-navy "></div>
                    <span className="text-fase-steel font-medium">Professional Excellence</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-fase-graphite  opacity-30 blur-lg"></div>
              </div>
            </div>
          </div>
        </ContentHero>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white  p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-fase-graphite to-green-600  flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              {/* Value 2 */}
              <div className="bg-white  p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-fase-navy to-blue-800  flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Value 3 */}
              <div className="bg-white  p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-fase-navy to-yellow-600  flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
