    ...
    <PageLayout currentPage="what-is-an-mga" sections={sections}>
      <main className="flex-1">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-futura font-bold text-fase-navy mb-6">The MGA Business Model</h2>
              </div>
              ...
              <div className="space-y-8 text-fase-steel">
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-12">
                  <div>
                    <h3 className="text-2xl font-futura font-semibold text-fase-navy mb-4">Focused Expertise</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-futura font-semibold text-fase-navy mb-4">Key Characteristics</h3>
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-futura font-bold text-fase-navy mb-6">Innovation & Technology</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="text-center">
                ...
                <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Risk Pricing</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Operational Efficiency</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-futura font-semibold text-fase-navy mb-2">Customer Experience</h3>
