        ...
        <ContentHero id="membership-types" fullHeight={true} className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {/* MGA Membership */}
              <div className="bg-fase-paper p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-fase-graphite">
                <div className="text-center">
                  ...
                  <div className="text-left space-y-3 mb-8">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-fase-graphite mr-2" fill="currentColor" viewBox="0 0 20 20">
